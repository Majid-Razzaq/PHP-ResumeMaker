            ...
            <div class="row sub-columns">
                ...
                <div class="col-lg-4 col-md-4 sub-two-right pl-lg-5">
                    ...
                    <ul>
                        ...
                        <li><a href="templates.php"><span class="fas fa-chevron-right mr-2"></span>Templates</a>
                        </li>
                        <li><a href="create-resume.php"><span class="fas fa-chevron-right mr-2"></span>Resume</a></li>
